...
const Categoria = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center space-y-20 pt-20 2xl:pt-0'>
      ...
      {elementosCategoria.length !== 0
        ? <div className='w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 place-content-center gap-10 px-10'>
