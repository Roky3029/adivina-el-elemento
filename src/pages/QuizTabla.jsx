...
const QuizTabla = () => {
  ...
  useEffect(() => {
    ...
    // comprobar que no cuente de nuevo si el elemento ya esta acertado
      ...
      <div className='lg:mt-0 mt-20 flex items-center justify-center flex-col gap-5'>
        {jugando && <div className='w-full flex md:flex-row flex-col items-center justify-center gap-10'>
          ...
          <div className='w-1/3 flex items-center justify-center'>
            <input type="text" disabled={showReason === 'win'} value={inputValue} autoFocus onChange={e => cambiarInputValue(e.target.value)} placeholder={!jugando ? '' : 'Escribe un elemento...'} className='p-5 rounded-lg text-xl outline-none' />
          </div>
