  ...
  return (
    <footer className='w-full bg-slate-600 flex flex-col items-center justify-center space-y-4 mt-28 py-10'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center text-5xl space-y-4 md:space-y-0 md:space-x-24'>
        <a href="https://www.instagram.com/kirkydev_30/" target="_blank" rel='noreferrer' className='bg-slate-400 rounded-3xl w-20 h-20 grid place-content-center p-4 transition-all text-slate-700 hover:scale-105 hover:bg-slate-500 hover:text-slate-400 '>
          <BsInstagram/>
        </a>
      ...
      <p className='w-full text-slate-500 text-right pr-10'>Version 2.3.0 </p>
    </footer>
  )
}
